...
public class SettingParticipantModel
{
    ...
    /// </summary>
    public MapPositionModel Position { get; set; } = new();
    ...
    public static SettingParticipantModel FromTrainer(TrainerModel trainer, MapPositionModel position)
    {
    ...
    /// <param name="gameId"></param>
    /// <param name="position"></param>
    public static SettingParticipantModel FromShop(ShopModel shop, MapPositionModel position)
    {
    ...
    public static SettingParticipantModel FromPokemon(PokemonModel pokemon, MapPositionModel position, SettingParticipantType type)
    {
    ...
    /// <param name="position"></param>
    /// <param name="type"></param>
    public static SettingParticipantModel FromNpc(NpcModel npc, MapPositionModel position, SettingParticipantType type)
    {
